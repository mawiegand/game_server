class Action::Fundamental::ChangeAllianceDescriptionActionsController < ApplicationController
  ...
  def create
    ...
    raise BadRequestError.new('missing parameter(s)') if params[:change_alliance_description_action].nil? || params[:change_alliance_description_action][:id].blank? || params[:change_alliance_description_action][:description].blank?
    ...
    raise ForbiddenError.new('tried to do change wrong alliance') unless current_character.alliance_id == params[:change_allience_description_action][:id]
    ...
    alliance.description = params[:change_allience_description_action][:description].strip
