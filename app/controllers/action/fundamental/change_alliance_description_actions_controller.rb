class Action::Fundamental::ChangeAllianceDescriptionActionsController < ApplicationController
  ...
  def create
    ...
    raise ForbiddenError.new('tried to do change wrong alliance') unless current_character.alliance_id == params[:change_alliance_description_action][:alliance_id].to_id
