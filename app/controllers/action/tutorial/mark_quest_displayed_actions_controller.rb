class Action::Tutorial::MarkQuestDisplayedActionsController < ApplicationController
  
  before_filter :authenticate

  def create
    @action = params[:action_tutorial_mark_quest_displayed_action]
    ...
    respond_to do |format|
      format.html { redirect_to action_path, notice: 'Quest was successfully marked has having been displayed.' }
