class Settlement::OutgoingTradingCartsController < ApplicationController
  ...
  def index
    ...
    @action_trading_trading_carts_actions = @settlement.outgoing_trading_carts.where(['"action_trading_trading_carts_actions"."returning" IS NULL OR "action_trading_trading_carts_actions"."returning" = ?', false]) || []
