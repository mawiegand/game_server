class Messaging::InboxEntry < ActiveRecord::Base
  ...
  attr_readable *readable_attributes(:default), :id, :inbox_id, :read, :message_id, :owner_id, :sender_id, :subject, :messages_count, :unread_messages_count, :updated_at, :created_at, :as => :owner
