...
ActiveRecord::Schema.define(:version => 20141017175618) do
  ...
  create_table "facebook_app_configs", :force => true do |t|
    t.string   "app_id"
    t.string   "app_secret"
    t.string   "app_token"
    t.datetime "created_at"
  ...
  create_table "military_battles", :force => true do |t|
    ...
    t.boolean  "removed",               :default => false, :null => false
    t.integer  "message_id"
    t.boolean  "alliance_fight",        :default => false
  end
  ...
  create_table "tutorial_states", :force => true do |t|
    ...
    t.integer  "count_quests_completed",                  :default => 0,     :null => false
  end
