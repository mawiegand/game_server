...
module JabberBots
  class Command
    ...
    def run_process(process_name, dir)
      JabberBots::Runloop.before_fork
    ...
    def run(worker_name = nil)
      ...
      logname = "jabber_bots_#{Rails.env}.log"

      JabberBots::Runloop.after_fork
      JabberBots::Runloop.logger ||= Logger.new(File.join(Rails.root, 'log', logname))

      runloop = JabberBots::Runloop.new(@options)
      runloop.start
    rescue => e
