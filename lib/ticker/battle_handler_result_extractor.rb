module Ticker
  ...
  #       :experience_gained => awe_army.sumNewExp,
        ...
        Ticker::Runloop::logger.add Logger::INFO, "--> EXP GAINED #{experience_gained} | #{awe_army.sumNewExp}" if !Ticker::Runloop::logger.nil?
    ...
    def extract_results_from_awe_participant(battle, awe_army, participant, participant_results)
      rules = GameRules::Rules.the_rules
