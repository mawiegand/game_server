...
<html>
  <head>
    <title>American English Rules Wack-a-Doo</title>
  ...
  <body>
    ...
    <xsl:apply-templates select="//Building|//Resource|//Science|//Unit|//UnitCategory|//AssignmentType" />
...
<![CDATA[
  ...
  <xsl:template match="Resource|Science|Unit|Building|UnitCategory|AssignmentType"> 

<xsl:text><![CDATA[
      <tr>
        <td>]]></xsl:text>
    <xsl:value-of select="@id"/><![CDATA[.name</td>
        <td>]]><xsl:value-of select="Name[@lang='en_US']"/> 
<xsl:text><![CDATA[</td>
        <td></td>
      </tr>]]></xsl:text>
...
<xsl:text><![CDATA[
    ...
    <xsl:value-of select="@id"/><![CDATA[.flavor</td>
        <td>]]><xsl:value-of select="Flavour[@lang='en_US']"/> 
<xsl:text><![CDATA[</td>
        <td></td>
      </tr>]]></xsl:text>
</xsl:if>   
...
<xsl:text><![CDATA[
      <tr>
        <td>]]></xsl:text>
    <xsl:value-of select="@id"/><![CDATA[.shortDescription</td>
        <td>]]><xsl:value-of select="ShortDescription[@lang='en_US']"/> 
<xsl:text><![CDATA[</td>
        <td></td>
      </tr>]]></xsl:text>
</xsl:if>  
...
<xsl:text><![CDATA[
    ...
    <xsl:value-of select="@id"/><![CDATA[.description</td>
        <td>]]><xsl:value-of select="Description[@lang='en_US']"/> 
<xsl:text><![CDATA[</td>
        <td></td>
      </tr>]]></xsl:text>
